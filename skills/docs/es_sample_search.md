...
【调用方式】: 必须严格以 JSON 字符串形式传入参数，禁止使用单引号。示例: python skills/es_sample_search.py "{\"task_ids\": [6860], \"start_time\": \"2026-04-24 00:00:00\", \"end_time\": \"2026-04-30 23:59:59\", \"size\": 10}"
【参数说明】 (以 JSON 字符串形式传入):
